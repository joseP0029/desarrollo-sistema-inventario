...
public class ProductoNoPerecible extends Producto{
    ...
    public ProductoNoPerecible(int id, int cantidad, String nombre, String categoria, String nombreFabricante, String detallesEnvio, float precio, Proveedor proveedor) {
